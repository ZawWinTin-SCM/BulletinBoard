...
class AppServiceProvider extends ServiceProvider
{
    ...
    {
        // Dao Registration
        $this->app->bind('App\Contracts\Dao\PasswordReset\PasswordResetDaoInterface', 'App\Dao\PasswordReset\PasswordResetDao');
        $this->app->bind('App\Contracts\Dao\Post\PostDaoInterface', 'App\Dao\Post\PostDao');
        $this->app->bind('App\Contracts\Dao\User\UserDaoInterface', 'App\Dao\User\UserDao');

        // Business logic registration
        $this->app->bind('App\Contracts\Services\PasswordReset\PasswordResetServiceInterface', 'App\Services\PasswordReset\PasswordResetService');
